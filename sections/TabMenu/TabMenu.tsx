...
export default function TabMenu({
  ...
  const FilePath = `{"sections":[{"__resolveType":"preview","block": "site/sections/CardPreview/CardPreview.tsx" },{"__resolveType":"deco"}]}`;
  ...
  return (
    <div class="container">
      <div class="flex flex-col items-center justify-center gap-4 w-full max-w-3xl mx-auto">
        <h2 class="text-4xl lg:text-6xl leading-none font-normal">{title}</h2>
        <span
      ...
      {tabMenu?.map((tabMenu) => (
        <>
          <p class="pb-4 pt-8 text-white">{tabMenu.title}</p>
          <div role="tablist" class="tabs">
            ...
            >
              <div class="pl-24">
                <iframe src={URL_PREVIEW} class={"w-full"}>
